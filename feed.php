<?php
    ...
    $query = mysqli_query($conn, "select * from user INNER JOIN `profile` on `user`.`username`=`profile`.`uname` where `username` = '".$user."' and `password` = '".$pass."'");
    while($row = mysqli_fetch_assoc($query)){
        $name = $row['name'];
    }
    $sql = mysqli_query($conn, "select * from `photo` where `usernm` = '".$user."' ");
        ...
        <div class="photo">
            <header class="photo__header">
                ...
                <div class="photo__user-info">
                    <span class="photo__author"><?php echo $name ?></span>
            ...
            <div class="photo__info">
                ...
                <span class="photo__likes"><?php echo $like ?> likes</span>
                <ul class="photo__comments">
                    <li class="photo__comment">
                        <span class="photo__comment-author"><?php echo $user ?></span> <?php echo $capt ?>
                    </li>
                </ul>
